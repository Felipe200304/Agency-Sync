        ...
        <AreaChart data={monthlyRevenue} margin={{ top: 5, right: 10, left: 0, bottom: 0 }}>
          <defs>
            <linearGradient id="colorReceita" x1="0" y1="0" x2="0" y2="1">
              <stop offset="5%" stopColor="oklch(0.78 0.09 85)" stopOpacity={0.3} />
              <stop offset="95%" stopColor="oklch(0.78 0.09 85)" stopOpacity={0} />
            </linearGradient>
            <linearGradient id="colorRepasses" x1="0" y1="0" x2="0" y2="1">
              <stop offset="5%" stopColor="oklch(0.50 0.06 85)" stopOpacity={0.2} />
              <stop offset="95%" stopColor="oklch(0.50 0.06 85)" stopOpacity={0} />
            </linearGradient>
          </defs>
          ...
          <Area type="monotone" dataKey="receita" name="Receita" stroke="oklch(0.78 0.09 85)" fill="url(#colorReceita)" strokeWidth={2} />
          <Area type="monotone" dataKey="repasses" name="Repasses" stroke="oklch(0.50 0.06 85)" fill="url(#colorRepasses)" strokeWidth={1.5} />
        </AreaChart>
      </ResponsiveContainer>
    </div>
  )
