...
import {
  ...
  UserCheck, Building2, ChevronLeft, ChevronRight, LogOut
} from 'lucide-react'
  ...
  return (
    ...
    >
      ...
      <div className="pb-4 px-2 space-y-0.5">
        <Link
          href="/"
          className="flex items-center gap-3 px-3 py-2.5 rounded-sm text-sm text-sidebar-foreground hover:bg-sidebar-accent hover:text-sidebar-accent-foreground transition-all"
        >
