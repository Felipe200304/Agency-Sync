...
export default async function ModeloAgendaPage() {
  ...
  // Casting é um teste para o trabalho — aqui só entram os que o modelo
  // confirmou e que têm data definida.
  const confirmed = jobs.filter(j => j.decision === 'confirmado' && j.date)
  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      <div className="mb-6 flex items-start justify-between gap-4">
        <div>
          <h1 className="font-heading text-3xl font-light">Minha Agenda</h1>
          <p className="text-muted-foreground text-sm mt-0.5">Seus castings confirmados</p>
        </div>
        {modelId && (
          <a
